...
const GITHUB_USER   = '𝐶𝑟𝑎𝑧𝑦ouafy';
const GITHUB_REPO   = 'betho-lite-ofc';
...
let handler = async (m, { text }) => {
  ...
  await m.reply(`🔍 كانبحث على بلوغينات 𝐶𝑟𝑎𝑧𝑦 (${label})...`);
...
handler.help = ['متتبع-الاضافات'];
handler.tags    = ['owner', 'tools'];
handler.command = ['متتبع-الاضافات'];
