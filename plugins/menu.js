...
import { menuButtons, downloaderCategoryButtons, searchCategoryButtons, channelButton } from '../system/buttons.js'
...
let handler = async (m, { conn, usedPrefix, command, args }) => {
  ...
  let docUrl = 'https://i.postimg.cc/02tkNSHj/IMG-20260610-WA0081.jpg'
  ...
  if (cmd === 'list') {
    ...
    const pp = await conn.profilePictureUrl(m.sender, 'image').catch((_) => "https://i.postimg.cc/2jFJGwzS/IMG-20260610-WA0072.jpg");
    ...
    const catButtons = cmd === 'downloader'
