...
handler.all = async function (m) {
  ...
  let fotonyu = "https://i.postimg.cc/Fsx4fvfK/IMG-20260610-WA0075.jpg";
  let logo = "https://i.postimg.cc/5NkJJV6H/IMG-20260610-WA0080.jpg"; // define logo aquí
  let namebot = "𝑩𝒆𝒕𝒉𝒐 𝑩𝒐𝒕 AI";
  let sig = "https://instagram.com/𝐶𝑟𝑎𝑧𝑦_ouafy";
  ...
  try {
    ...
    global.emror = "https://i.postimg.cc/2jFJGwzS/IMG-20260610-WA0072.jpg";
    ...
    global.kontak2 = [
      [
        owner[0],
        await conn.getName(owner[0] + "201214057674@s.whatsapp.net"),
        "Betho Bot",
        "https://whatsapp.com",
        true,
      ],
    ...
    global.adReply = {
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          serverMessageId: 103,
          newsletterName: `𝑩𝒆𝒕𝒉𝒐 𝑩𝒐𝒕 AI    |   هيا نحو النجاح 🧑‍🏫`,
        },
        externalAdReply: {
          title: namebot,
          body: global.ucapan,
