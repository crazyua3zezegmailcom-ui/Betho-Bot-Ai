...
let handler = async (m, { conn, args, text, command }) => {
    ...
    const sub = command === 'صور-يوتيوب' ? (args[0] || '').toLowerCase() : command;
    const url = command === 'صور-يوتيوب' ? args.slice(1).join(' ').trim() : text;
...
handler.help    = ['صورة-مصغرة', 'ملف-قناة-يوت', 'لافتة-يوت', 'تعليق-يوتيوب'];
handler.command = ['صور-يوتيوب', 'صورة-مصغرة', 'ملف-قناة-يوت', 'لافتة-يوت', 'تعليق-يوتيوب'];
