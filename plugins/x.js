...
let handler = async (m, { conn, text }) => {
    ...
    try {
        ...
        if (result.type === "video") {
            ...
            if (!selectedVideo) return conn.sendMessage(m.chat, { sticker: { url: 'https://i.postimg.cc/2jFJGwzS/IMG-20260610-WA0072.jpg' } });

            await conn.sendMessage(m.chat, { video: { url: selectedVideo.url } });
            conn.sendMessage(m.chat, { sticker: { url: 'https://i.postimg.cc/gksCzK5n/IMG-20260610-WA0076.jpg' } });
        } else if (result.type === "image") {
            let selectedImage = result.download[0]; 

            if (!selectedImage) return conn.sendMessage(m.chat, { sticker: { url: 'https://i.postimg.cc/Fsx4fvfK/IMG-20260610-WA0075.jpg' } });

            await conn.sendMessage(m.chat, { image: { url: selectedImage.url } });
            conn.sendMessage(m.chat, { sticker: { url: 'https://i.postimg.cc/5NkJJV6H/IMG-20260610-WA0080.jpg' } });
        } else {
            conn.sendMessage(m.chat, { sticker: { url: 'https://i.postimg.cc/2jFJGwzS/IMG-20260610-WA0072.jpg' } });
        }
    } catch (e) {
        conn.sendMessage(m.chat, { sticker: { url: 'https://i.postimg.cc/gksCzK5n/IMG-20260610-WA0076.jpg' } });
