	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: '.𓏲⋆˙𝑵𝜩𝒁𝑼𝑲̤͝𝜣͓ۧٛ͢ ͝ 𝑩𝜩𝑻𝑯𝑶̤͝𝜣͓ۧٛ͢', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363428186936884@newsletter", "120363428186936884@newsletter", "120363428186936884@newsletter", "120363428186936884@newsletter", "120363428186936884@newsletter"]
let canalNombre = [".𓏲⋆˙𝑵𝜩𝒁𝑼𝑲̤͝𝜣͓ۧٛ͢ ͝ 𝑩𝜩𝑻𝑯𝑶̤͝𝜣͓ۧٛ͢", ".𓏲⋆˙𝑵𝜩𝒁𝑼𝑲̤͝𝜣͓ۧٛ͢ ͝ 𝑩𝜩𝑻𝑯𝑶̤͝𝜣͓ۧٛ͢", ".𓏲⋆˙𝑵𝜩𝒁𝑼𝑲̤͝𝜣͓ۧٛ͢ ͝ 𝑩𝜩𝑻𝑯𝑶̤͝𝜣͓ۧٛ͢", ".𓏲⋆˙𝑵𝜩𝒁𝑼𝑲̤͝𝜣͓ۧٛ͢ ͝ 𝑩𝜩𝑻𝑯𝑶̤͝𝜣͓ۧٛ͢", ".𓏲⋆˙𝑵𝜩𝒁𝑼𝑲̤͝𝜣͓ۧٛ͢ ͝ 𝑩𝜩𝑻𝑯𝑶̤͝𝜣͓ۧٛ͢", '.𓏲⋆˙𝑵𝜩𝒁𝑼𝑲̤͝𝜣͓ۧٛ͢ ͝ 𝑩𝜩𝑻𝑯𝑶̤͝𝜣͓ۧٛ͢'] 
...
sendBtImg: {
    async value(jid, buffer, text = '', footer = '', buttons, quoted, options) {
        let img;
        ...
        if (/^https?:\/\//i.test(buffer)) {
            ...
            try {
                ...
                if (/^image\//i.test(type.mime)) {
                    ...
                    console.error("Tipo MIME no compatible:", type);
                }
            } catch (error) {
                console.error("Error al obtener el tipo de archivo:", error);
            }
        ...
        // تقسيم الأزرار إلى مجموعات كل مجموعة تحتوي على 15 زرار كحد أقصى
        let groups = [];
        while (buttons.length) {
            groups.push(buttons.splice(0, 15));
        }

        // إرسال كل مجموعة كرسالة منفصلة
        for (let group of groups) {
            const dynamicButtons = group.map(btn => ({
                buttonId: btn[1],
                buttonText: {
                    displayText: btn[0],
                },
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.create({
                        ...
                        ...Object.assign({
                            ...
                            contextInfo: {
                                ...
                                isForwarded: true,
                                forwardedNewsletterMessageInfo: {
                                    newsletterJid: '120363323510940493@newsletter',
