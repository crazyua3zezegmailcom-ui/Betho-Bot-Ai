...
const canWel = await new canvafy.WelcomeLeave()
    .setAvatar(pp)
    .setBackground("image", "https://i.postimg.cc/2jFJGwzS/IMG-20260610-WA0072.jpg")
    .setTitle("Welcome")
...
const canLea = await new canvafy.WelcomeLeave()
    .setAvatar(pp)
    .setBackground("image", "https://i.postimg.cc/Fsx4fvfK/IMG-20260610-WA0075.jpg")
    .setTitle("Goodbye")
    ...
    this.sendMessage(id, {
        ...
        mentionedJid: [user],
            externalAdReply: {
                containsAutoReply: true,
                mediaType: 1,
                mediaUrl: 'https://i.postimg.cc/5NkJJV6H/IMG-20260610-WA0080.jpg',
                renderLargerThumbnail: true,
                showAdAttribution: true,
                sourceUrl: null,
                thumbnailUrl: pp,
...
async function getMessage(key){
        ...
        return {
            conversation: "My name is Betho Bot"
        }
    }
...
let msg = {
        ...
        gconly: `📢 لا يمكنك الوصول إلى ميزة ❗\nانضم إلى مجموعة Betho Bot Bot لتتمكن من الوصول\n\n> ${global.url.sgc}`,
